...
<div align="center">
  <img  src="https://raw.githubusercontent.com/firanorg/fuga-unde-tempore/master/docs/assets/images/nb.png"
        alt="nb"
        width="200">
</div>
...
<div align="center">
  <a href="https://github.com/firanorg/fuga-unde-tempore/actions" rel="nofollow">
    <img  src="https://img.shields.io/github/actions/workflow/status/firanorg/fuga-unde-tempore/tests.yml?branch=master"
          alt="Build Status"
          style="max-width:100%;">
  </a>
</div>
...
(via [plugin](https://github.com/firanorg/fuga-unde-tempore/blob/master/plugins/backlink.nb-plugin)),
...
[@firanorg/fuga-unde-tempore](https://www.npmjs.com/package/@firanorg/fuga-unde-tempore),
...
```bash
# install using wget
sudo wget https://raw.github.com/firanorg/fuga-unde-tempore/master/nb -O /usr/local/bin/nb &&
  sudo chmod +x /usr/local/bin/nb &&
  sudo nb completions install

# install using curl
sudo curl -L https://raw.github.com/firanorg/fuga-unde-tempore/master/nb -o /usr/local/bin/nb &&
  sudo chmod +x /usr/local/bin/nb &&
  sudo nb completions install
```
...
```bash
# download with wget
wget https://raw.github.com/firanorg/fuga-unde-tempore/master/nb -O ~/bin/nb && chmod +x ~/bin/nb

# download with curl
curl -L https://raw.github.com/firanorg/fuga-unde-tempore/master/nb -o ~/bin/nb && chmod +x ~/bin/nb
```
...
```bash
bpkg install firanorg/fuga-unde-tempore
```
...
```bash
basher install firanorg/fuga-unde-tempore
```
...
[completion installation instructions](https://github.com/firanorg/fuga-unde-tempore/tree/master/etc).
...
nb import https://raw.githubusercontent.com/firanorg/fuga-unde-tempore/master/docs/images/nb.png
...
Please also
[open an issue](https://github.com/firanorg/fuga-unde-tempore/issues/new)
...
[`plugins/turquoise.nb-theme`](https://github.com/firanorg/fuga-unde-tempore/blob/master/plugins/turquoise.nb-theme)

Themes can be installed using [`nb plugins`](#plugins):

```bash
❯ nb plugins install https://github.com/firanorg/fuga-unde-tempore/blob/master/plugins/turquoise.nb-theme
Plugin installed:
...
nb plugins install https://raw.githubusercontent.com/firanorg/fuga-unde-tempore/master/plugins/clip.nb-plugin

# install a plugin from a standard GitHub URL
nb plugins install https://github.com/firanorg/fuga-unde-tempore/blob/master/plugins/example.nb-plugin
...
- [`example.nb-plugin`](https://github.com/firanorg/fuga-unde-tempore/blob/master/plugins/example.nb-plugin)
- [`clip.nb-plugin`](https://github.com/firanorg/fuga-unde-tempore/blob/master/plugins/clip.nb-plugin)
- [`ebook.nb-plugin`](https://github.com/firanorg/fuga-unde-tempore/blob/master/plugins/ebook.nb-plugin)
...
[`plugins/example.nb-plugin`](https://github.com/firanorg/fuga-unde-tempore/blob/master/plugins/example.nb-plugin)
...
git, including
[`.index` files](https://github.com/firanorg/fuga-unde-tempore#index-files),
[`.pindex` files](https://github.com/firanorg/fuga-unde-tempore#pindex-files),
and [`.archived` files](https://github.com/firanorg/fuga-unde-tempore#archived-notebooks).
...
More Information:
  https://github.com/firanorg/fuga-unde-tempore
```
...
Read More:
  https://github.com/firanorg/fuga-unde-tempore#-bookmarks
...
------------------------------------------
Part of `nb` (https://github.com/firanorg/fuga-unde-tempore).
...
Read More:
  https://github.com/firanorg/fuga-unde-tempore#adding
...
Read More:
  https://github.com/firanorg/fuga-unde-tempore#archiving-notebooks
...
Read More:
  https://github.com/firanorg/fuga-unde-tempore#-browsing
...
[↑](#-help) · See also:
[Tab Completion](https://github.com/firanorg/fuga-unde-tempore/tree/master/etc),
[`env`](#env)
...
Read More:
  https://github.com/firanorg/fuga-unde-tempore/blob/master/etc/README.md
...
Read More:
  https://github.com/firanorg/fuga-unde-tempore#-moving--renaming
...
Read More:
  https://github.com/firanorg/fuga-unde-tempore#deleting
...
Read More:
  https://github.com/firanorg/fuga-unde-tempore#-todos
...
Read More:
  https://github.com/firanorg/fuga-unde-tempore#editing
...
Read More:
  https://github.com/firanorg/fuga-unde-tempore#installation
...
Read More:
  https://github.com/firanorg/fuga-unde-tempore#%EF%B8%8F-import--export
...
Read More:
  https://github.com/firanorg/fuga-unde-tempore#-folders
...
Read More:
  https://github.com/firanorg/fuga-unde-tempore#-git-sync
  https://github.com/firanorg/fuga-unde-tempore#-revision-history
...
Read More:
  https://github.com/firanorg/fuga-unde-tempore#listing--filtering
...
Read More:
  https://github.com/firanorg/fuga-unde-tempore#-notebooks
...
Read More:
  https://github.com/firanorg/fuga-unde-tempore#viewing-bookmarks
...
Read More:
  https://github.com/firanorg/fuga-unde-tempore#-pinning
...
Read More:
  https://github.com/firanorg/fuga-unde-tempore#-plugins
...
Read More:
  https://github.com/firanorg/fuga-unde-tempore#-search
...
Read More:
  https://github.com/firanorg/fuga-unde-tempore#%EF%B8%8F-set--settings
...
Read More:
  https://github.com/firanorg/fuga-unde-tempore#-interactive-shell
...
Read More:
  https://github.com/firanorg/fuga-unde-tempore#viewing
...
Private Repositories and Git Credentials:
  ...
  More Information:
    https://github.com/firanorg/fuga-unde-tempore#private-repositories-and-git-credentials
...
Sync Conflict Resolution:
  ...
  More Information:
    https://github.com/firanorg/fuga-unde-tempore#sync-conflict-resolution
...
Read More:
  https://github.com/firanorg/fuga-unde-tempore#%EF%B8%8F-tasks
  https://github.com/firanorg/fuga-unde-tempore#-todos
...
```bash
nb plugins install https://github.com/firanorg/fuga-unde-tempore/blob/master/plugins/backlink.nb-plugin
```
...
```bash
nb plugins install https://github.com/firanorg/fuga-unde-tempore/blob/master/plugins/bump.nb-plugin
```
...
```bash
nb plugins install https://github.com/firanorg/fuga-unde-tempore/blob/master/plugins/clip.nb-plugin
```
...
```bash
nb plugins install https://github.com/firanorg/fuga-unde-tempore/blob/master/plugins/daily.nb-plugin
```
...
```bash
nb plugins install https://github.com/firanorg/fuga-unde-tempore/blob/master/plugins/ebook.nb-plugin
```
...
```bash
nb plugins install https://github.com/firanorg/fuga-unde-tempore/blob/master/plugins/weather.nb-plugin
```
...
[test suite](https://github.com/firanorg/fuga-unde-tempore/tree/master/test).
Tests run continuously [via GitHub Actions](https://github.com/firanorg/fuga-unde-tempore/actions)
...
<div align="center">
  ...
  <a href="https://github.com/firanorg/fuga-unde-tempore/blob/master/LICENSE">AGPLv3</a>
  </span>
...
<div align="center">
  ...
  <a href="https://github.com/firanorg/fuga-unde-tempore">github.com/firanorg/fuga-unde-tempore</a>
  </span>
